...
class Character:public Being {
 public:
	...
	enum ReadyResult {
	 ...
	 Character(const char *tag, const char *name,
		   ...
		   int mpmod, int mpmult, int hp, int xp, int mp, int lvl);
	 virtual ~ Character();
	...
	void taskAbort();
	void taskBegin(char *taskname, struct closure *taskproc,
		       struct gob *taskgob);
	void taskContinue(char *taskname, struct closure *taskproc,
			  struct gob *taskgob);
	void taskEnd();
	bool engagedInTask();
 ...
 private:
	...
	bool exitMap();
	void taskCleanup();
	void taskSetup(char *taskname, struct closure *taskproc,
		       struct gob *taskgob);
