...
(define (abe-join knpc kpc)
  (say knpc "Oh, no, I couldn't possibly..."
...
(define (abe-keys knpc kpc)
  (say knpc "The Demon Gate was locked with eight locks,"
...
(define (abe-quee knpc kpc)
  (say knpc "I'm not sure what you are insinuating."))

(define (abe-civi knpc kpc)
  (say knpc "I don't know much about the civilization that built the ruins,"
       " but clues indicate it was quite wicked by our standards!"
...
(define (abe-accu knpc kpc)
  (say knpc "Yes, the Accursed have a long history."
...
(define (abe-bye knpc kpc)
  (say knpc "Let me know if you find any ruins!"))

(define (abe-alch knpc kpc)
  (say knpc "How is the secretive old rascal?"
...
(define (abe-flee knpc kpc)
  (say knpc "[He sighs] It's a long story. Ask around."
       "It doesn't matter anymore."))

(define (abe-gobl knpc kpc)
  (say knpc "Deric and Gen have a lot of experience with goblins."))
